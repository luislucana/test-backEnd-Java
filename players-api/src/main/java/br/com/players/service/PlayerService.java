...
public class PlayerService {
	...
	/**
	 * Busca um player, dado um ID.
	 * 
	 * @param id
	 * @return o player com o ID informado.
	 */
	...
	public PlayerVO updatePlayer(PlayerVO playerVO, Long id) {
		if (playerVO.getId() != id) {
			throw new IllegalArgumentException("Identificador inválido de jogador:" + id);
		}
		...
		// caso o usuario mude o grupo, sera feita a validacao de codinomes disponiveis
		if (grupoSelecionado != PlayerGroupEnum.valueOf(player.getGrupo())) {
			List<String> codinomesDisponiveisList = obterCodinomesDisponiveis(grupoSelecionado);
